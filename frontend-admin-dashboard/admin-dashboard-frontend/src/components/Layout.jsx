...
export default function Layout() {
  ...
  const isPolicyPage =
    location.pathname === "/policy" || location.pathname.startsWith("/policy/");
  const isPayrollPage =
    location.pathname === "/payroll" || location.pathname.startsWith("/payroll/");
  const isCommandCenterPage =
    location.pathname === "/command-center" || location.pathname.startsWith("/command-center/");
  ...
  const isIncidentsPage =
    location.pathname === "/incidents" || location.pathname.startsWith("/incidents/");
  const isAnnouncementsPage =
    location.pathname === "/announcements" || location.pathname.startsWith("/announcements/");
  const isAccountPage =
