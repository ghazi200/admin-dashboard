...
/**
 * Session timeout after inactivity (15–60 minutes). Clears guard session and redirects to /login.
 * @param {Object} options - { enabled: boolean, timeoutMinutes: number (15-60) }
 */
export function useSessionTimeout(options = {}) {
  const { enabled = true, timeoutMinutes: optionMinutes } = options;
  ...
  }, [enabled, timeoutMinutes, onActivity]);
}
