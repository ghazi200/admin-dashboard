...
async function testCalloutAcceptanceFlow() {
  ...
  try {
    ...
    // The backend would:
    // 1. Open the shift (set guard_id = NULL, status = 'OPEN')
    // 2. Rank eligible guards
    // 3. Create callout records
    // 4. Notify guards
    ...
    console.log("\n📊 Flow Summary:");
    console.log("   1. ✅ Guard called out (shift opened)");
    console.log("   2. ✅ AI ranked eligible guards");
    console.log("   3. ✅ Callout records created for top guards");
    console.log("   4. ✅ Guard accepted callout");
    console.log("   5. ✅ Shift assigned and closed");
    console.log("   6. ✅ Guard metrics updated");
